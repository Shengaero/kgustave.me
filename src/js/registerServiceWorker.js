    ...
    window.addEventListener('load', () => {
      ...
      if(isLocalhost) {
        ...
        navigator.serviceWorker.ready.then(() => {
          ...
          console.log('Failed to register a service-worker:', reason);
        });
      } else {
      ...
      installingWorker.onstatechange = function() {
        if(installingWorker.state === 'installed') {
          if(navigator.serviceWorker.controller) {
            ...
            // It's the perfect time to display a "Content
...
function checkValidServiceWorker(swUrl) {
  ...
  fetch(swUrl).then(response => {
    // Ensure service worker exists, and that we
    //really are getting a JS file.
...
export function unregister() {
  if('serviceWorker' in navigator) {
    navigator.serviceWorker.ready.then(registration => {
      ...
      console.log('Failed to unregister a service-worker:', reason);
    });
  }
}
